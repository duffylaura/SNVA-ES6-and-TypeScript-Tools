...
/*  EXERCISE 1
    ...
    interface Loan {
      ...
      function calculateConventionalLoanPayment(loan: ConventionalLoan) {
        ...
        let interest = loan.interestRate / 1200; // Calculates the Monthly Interest Rate of the loan
        let payment;
        payment = loan.principle * interest / (1 - (Math.pow(1 / (1 + interest), loan.months)));
        return 'The conventional loan payment is ' + payment.toFixed(2);
      }
      
      let interestOnlyPayment = calculateInterestOnlyLoanPayment({principle: 30000, interestRate: 5, months: 0});
